...
photo_hashes = [
  { :caption => "Peyton Manning", :image_url => "pm.jpg" },
  { :caption => "Drew Brees", :image_url => "db.jpg" },
  { :caption => "Aaron Rodgers", :image_url => "ar.jpg" },
  { :caption => "Cam Newton", :image_url => "cm.jpg" }
]
...
favorite_hashes = [
  { :nickname => "Raghu", :captions => ["Peyton Manning", "Aaron Rodgers"] },
  { :nickname => "Roneesh", :captions => ["Drew Brees", "Cam Newton"] }
]
